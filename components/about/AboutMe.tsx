...
export default function AboutMe() {
  ...
  return (
    <section
      className="min-h-fit flex items-start justify-center  px-4 py-15 "
      id="about"
    >
      <div className="max-w-7xl w-full mx-auto flex flex-col items-center gap-5 rtl:space-y-3">
        ...
        <p className="text-foreground/50 text-center max-w-3xl xl:max-w-4xl text-base md:text-lg xl:text-2xl leading-relaxed tracking-wide font-light">
          {t('aboutText')}
        </p>
